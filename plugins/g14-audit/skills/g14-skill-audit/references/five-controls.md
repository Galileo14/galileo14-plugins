...
url: example.com/category/topic
language: en
pages_to_scrape: 3
...
**`references/` also holds** any material Claude should read before or during a run:
...
That's expensive, and grows less accurate as it fills.
...
secretly condescending. A skill can have all of Controls 1 to 4 wired and still
...
${CLAUDE_PLUGIN_ROOT}/skills/g14-skill-audit/agents/grader.md
